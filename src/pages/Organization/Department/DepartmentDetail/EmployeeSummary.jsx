...
const EmployeeSummary = () => {
    ...
    }, [dispatch, searchTerm, visibleCount, currentPage, statusFilter]);
                                        ...
                                        <td className="td">
                                          ...
                                          <td className="td">
                                                    <div className="contact-info ">
                                                        <div className="loadingtdTOP"><Mail size={14} /> <span>{employee?.email}</span></div>
                                                        <div className="loadingtdBOTTOM "><Phone size={14} />
                                                            <span className="phone Bold">{employee?.mobile_no}</span></div>
                                                    </div>
                                                </td>
