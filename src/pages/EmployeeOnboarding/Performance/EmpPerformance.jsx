...
export const EmpPerformance = () => {
    ...
    console.log("performanceDetailsData", performanceDetailsData)
    ...
    const setYearData = useCallback((data) => {
        ...
        const fetchPerformance = useCallback(() => {    
            ...
            // if (id && performanceDetails?.user_id != id) {
...
console.log(performanceDetails)
    useEffect(() => {
        if (performanceDetails) {
            const technical = performanceDetails?.technical? JSON.parse(performanceDetails?.technical) : []
            const organisation = performanceDetails?.organisation ? JSON.parse(performanceDetails?.organisation) :[]
        ...
        <div className="performance-container otherDetailPageSroll">
            ...
            <div className="card performance-stats-card">
                ...
                {!performanceLoading && currentData?.length === 0 ? (
                    <ListDataNotFound module="Performance" />
                ) : (
                    <>
