...
import { GET_CITY_LIST_FAILURE, GET_CITY_LIST_REQUEST, GET_CITY_LIST_SUCCESS, GET_COUNTRY_LIST_FAILURE, GET_COUNTRY_LIST_REQUEST, GET_COUNTRY_LIST_SUCCESS, GET_STATE_LIST_FAILURE, GET_STATE_LIST_REQUEST, GET_STATE_LIST_SUCCESS, GET_WORK_LOCATION_LIST_FAILURE, GET_WORK_LOCATION_LIST_REQUEST, GET_WORK_LOCATION_LIST_SUCCESS } from "../Constants/locationConstants";
import { fetchCities, fetchCountries, fetchStates, fetchWorkLocation } from "../../services/location";
...
export const getWorkLocationList = (params) => async (dispatch) => {
    dispatch({ type: GET_WORK_LOCATION_LIST_REQUEST });
    try {
        const response = await fetchWorkLocation(params);
        dispatch({ type: GET_WORK_LOCATION_LIST_SUCCESS, payload: response.data });
        return response;
    } catch (error) {
