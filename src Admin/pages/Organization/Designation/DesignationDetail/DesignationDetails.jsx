...
import { getDesignationDetails, updateDesignationStatus } from '../../../../Redux/Actions/designationActions.js';
...
const DesignationDetails = () => {
    ...
    const updateStatus = useSelector((state) => state?.updateDesgnStatus);
    ...
    useEffect(() => {
        if (id && designationDetail) {
            setFormData((prev) => ({
                ...
                department_name: designationDetail?.department? designationDetail?.department?.department_name : "",
    ...
    const handleUpdateStatus = () => {
        ...
        dispatch(updateDesignationStatus(sendData))
            .then((res) => {
                if (res?.success) {
                    setShowModal(false);
                    dispatch(getDesignationDetails({ id }));
