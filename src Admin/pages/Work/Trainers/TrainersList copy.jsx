    ...
    return (
        <div className="attendanceListMain">
            <div className="employee-dashboard-list empListMain">
                ...
                {(trainerListLoading && !showMoreLess) ? (
                    <DynamicLoader listType="emp-a-5" type={"list"} count={itemsPerPage} />
                ) : (
                                ...
                                {trainerLists?.length > 0 ? (
                                                    ...
                                                    >
                                                        <td>
                                                            <div className="info_img">
                                                                <div className="name">{item?.trainer_name}</div>
                                                            </div>
                                                        </td>
                                                        <td>{showMastersValue(masterData, "22", item?.training_type)}</td>
                                                        <td>
                                                            <div className="contact-info">
                                                                <div><Mail size={14} /> <span>{item?.email}</span></div>
                                                                <div><Phone size={14} /> <span className="phone">{item?.contact_no}</span></div>
                                                            </div>
                                                        </td>
                                                        <td>
                                    ...
                                    <>
                                        {(!trainerListLoading && trainerLists?.length === 0) && (
                                            <ListDataNotFound module="Trainers" handleReset={resetFilters} />
                                        )}
                                    </>
                                )}
