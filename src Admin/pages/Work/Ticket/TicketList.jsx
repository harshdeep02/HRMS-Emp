...
import '../../Attendance/Assign Shift/AssignShiftList.scss'
...
export const TicketList = () => {
    ...
    const handleImportRow = async (row) => {
        const payload = {
            ...
            requested_to: row['Requested To'],
            priority: row['Priority'],
            created_at: row['Creation Date'],
            status: row['Status'],
        };
        // return dispatch(createNewTicket(payload));
    };
                    ...
                    <header className="top-header">
                        <div className="header-left">
                            ...
                            <div>
                                ...
                                <p>See All Daily Ticket List Below</p>
                            </div>
                        </div>
                        <div className="header-right">
                            <div className="toolbar">
                                <SearchBox
                                    ...
                                    placeholder="Search Employee, Requested To..."
                                    ref={searchBoxRef}
                                />
                                                        ...
                                                        <td>
                                                            <div className="employee-info info_img">
                                                                <div className="avatar-icon loadingImg">
                                                                    <img src={employeeImage(item?.user?.image)} alt={item?.user?.first_name || item?.user?.last_name || "-"} className="avatar" />
                                                                </div>
                                                                <div className="name loadingtdsmall Semi_Bold">{[item?.user?.first_name, item?.user?.last_name].filter(Boolean).join(" ")}</div>
                                                            </div>
                                                        </td>
