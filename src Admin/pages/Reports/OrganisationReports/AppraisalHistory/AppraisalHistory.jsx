        ...
        <div className="leave-report-page">
            ...
            <div className="leave-dashboard-header">
                <header className="leave-top-header">
                    ...
                    <div className="apraisallHeadRight" style={{display:"flex", marginBottom:"24px"}}>
                        ...
                        <div className="toolbar" style={{padding:0}}>
                            <SearchBox
                                ...
                                />
                            <div className="toolbar-actions" style={{ marginRight: "10px"}}>
                    ...
                    <div className="header-right export-button-main" style={{marginTop:0}}>
                        <ExportList
                                            ...
                                            return (
                                                <>
                                                    <tr key={item.id} className="employee-row">
                                                        ...
                                                        <td>
                                                            <div className="designation loadingtd">{item?.department?.department_name}</div>
                                                        </td>
                                                        <td>
