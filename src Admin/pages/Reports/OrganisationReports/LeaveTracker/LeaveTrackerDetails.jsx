...
import { ArrowUpRight, ChevronDown, CheckCircle2, User, TrendingUp, Clock, ShieldX, SquareMenu, XCircle } from "lucide-react";
import { FaUser } from "react-icons/fa";
import './LeaveReport.scss'; // Import the new SCSS file
import ExportList from '../../../../utils/common/Export/ExportList.jsx';
import { LeaveReportStatusOptions, leavesStatusOptions, leaveStatusOptions } from '../../../../utils/Constant.js';
...
const LeaveTrackerDetails = () => {
    ...
    }, [dispatch, statusFilter, visibleCount2,dateFilter, leaveTypeFilter]);
    ...
    const handleShowLess2 = () => {
        setVisibleCount2(INITIAL_VISIBLE_COUNT);
        setShowMoreLess2(true);
    };
    ...
    const dummData = Array.from({ length: 4 }, (_, i) => ({
        id: i,
        first_name: "",
        last_name: "",
    ...
    return (
        <div className="leave-report-page">
                                ...
                                {leaveBalnceListData?.map(item => {
                                    return (
                                        <tr key={item?.id} className="employee-row">
                                            <td className="loadingtd Semi_Bold"><div className="name">{item?.leave_name}</div></td>
            ...
            <div className="detail-table-wrapper detail-table-wrapper_none">
                                ...
                                {ListData?.map(item => {
                                    ...
                                    return (
                                        <tr key={item?.id} className="employee-row decTablHeight">
                                            <td className="loadingtd Semi_Bold"><div className="name">{item?.leave_master?.leave_name}</div></td>
                                            <td className="loadingtd"><div className="department">{formatDate(item?.from_date)}</div></td>
...
export default LeaveTrackerDetails;