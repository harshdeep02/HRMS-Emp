...
export const EmployeeFilesList = () => {
    ...
    const statusConfig = employeeFilesStatusOptions?.reduce((acc, status) => {
    ...
    const fetchFilesList = useCallback(async () => {
        try {
            ...
            console.error("Error fetching Employee Files list:", error);
            setShowMoreLess(false);
        }
                    ...
                    <header className="top-header">
                        ...
                        <div className="header-right">
                            ...
                            <Tooltips title='Add New File' placement="top" arrow={true}>
                                <button className="add-employee-btn" onClick={() => navigate('/add-employee-file')}><UserPlus size={16} /> </button>
                            </Tooltips>
                ...
                <main className={`dashboard-content`} >
                    <>
                        <aside className="filters-sidebar">
                            <div>
                                <ul>
                                    {employeeFilesStatusOptions?.map(status => {
                                        ...
                                        {ListData?.map(item => {
                                            ...
                                            return (
                                                <tr
                                                    ...
                                                    onClick={() => navigate(`/employee-file-details/${item?.id}`)}
                                                >
