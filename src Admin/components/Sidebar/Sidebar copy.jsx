...
export const menuItems = [
    ...
    },
    {
        id: 'employee', label: 'Employee', icon: IdCardLanyard, path: '/employee-list', submenu: [
            { label: 'Job', path: '/job-list', BreadL:'All Job list', detail: '/job-details', add: '/add-new-job', edit: '/edit-job-details' },
            { label: 'Applicant', path: '/applicant-list', BreadL:'All Applicant list', detail: '/applicant-details', add: '/add-applicant', edit: '/edit-applicant' },
            { label: 'Employee Onboarding',BreadL:'All Employee list', path: '/employee-list', detail: '/employee-details', add: '/add-employee', edit: '/edit-employee' },
        ]
    },
    {
        id: 'organization', label: 'Organization', icon: Building2, path: '/department-list', submenu: [
            { label: 'Department', path: '/department-list',BreadL:'All Department list', detail: '/department-details', add: '/add-department', edit: '/edit-department' },
            { label: 'Designation', path: '/designation-list', BreadL:'All Designation list', detail: '/designation-details', add: '/add-designation', edit: '/edit-designation' },
            { label: 'Employee Health', path: '/employee-health-list', BreadL:'All Employee Health list', detail: '/employee-health-details', add: '/add-new-employee-health', edit: '/edit-employee-health' },
            { label: 'Birthday', path: '/birthday-list', BreadL:'All Birthday list' },
            { label: 'Announcement', path: '/announcement-list', BreadL:'All Announcement list', detail: '/announcement-details', add: '/add-new-announcement', edit: '/edit-announcement' },
        ]
    },
    {
        id: 'attendance', label: 'Attendance', icon: Calendar, path: '/attendance-list', submenu: [
            { label: 'Holiday', path: '/holiday-list', detail: '/holiday-details', add: '/add-holiday-details', edit: '/edit-holiday-details' },
            { label: 'Shift', path: '/shift-list', detail: '/shift-details', add: '/add-shift', edit: '/edit-shift' },
            { label: 'Assign Shift', path: '/assign-shift-list', add: '/assign-shift'},
    ...
    },
    {
        id: 'leave', label: 'Leave Tracker', icon: CalendarMinus, path: '/leave-list', submenu: [
            ...
            { label: 'Leave Type', path: '/leave-type-list', detail: '/leave-type-details', add: '/add-leave-type', edit: '/edit-leave-type' },
        ...
        <aside className={`sidebar ${isExpanded ? 'expanded' : 'collapsed'}`} ref={settingRef}>
            ...
            <div className={`settingTool ${showSetting ? 'showSettingPopup' : ''}`}>
                <div className="settingToolFlex">
                    ...
                    <div className="sideSetting disFlex" onClick={() => handleNavgation('setting')}><div className="settingToolIcon"><Settings size={20} /></div><div className="settingToolText">Settings</div></div>
